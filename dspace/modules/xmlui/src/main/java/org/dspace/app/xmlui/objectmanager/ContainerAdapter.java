    ...
    protected void renderDescriptiveSection() throws WingException, SAXException, CrosswalkException, IOException, SQLException
    {
        ...
        if(dmdTypes.isEmpty() || dmdTypes.contains("DIM"))
        {
            ...
            if (dso.getType() == Constants.COLLECTION)
            {
                ...
                // grab the project master item if it exists String value = getCollectionService().getMetadataFirstValue(this, MetadataSchema.DC_SCHEMA, "title", null, Item.ANY);
                String projectMasterURI = collectionService.getMetadata(collection, "vsim.relation.projectMaster");
